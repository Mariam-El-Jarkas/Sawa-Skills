...
import {
  Users, BookOpen, FileText, ArrowLeftRight, Flag,
  ShieldCheck, Heart, Bell, BarChart3, ScrollText,
...
const navItems = [
  ...
  { path: '/reports', icon: Flag, label: 'Reports', badge: 14 },
  { path: '/verification', icon: ShieldCheck, label: 'Verification', badge: 28 },
...
export default function Sidebar() {
  ...
  return (
    <aside className={clsx(
      'h-screen flex flex-col bg-white border-r border-gray-100 transition-all duration-300 relative flex-shrink-0',
      collapsed ? 'w-16' : 'w-60'
    )}>
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-100">
        ...
        {!collapsed && (
          <div>
            <p className="font-bold text-gray-900 text-sm">Sawa Skills</p>

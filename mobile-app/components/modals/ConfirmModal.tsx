...
export const ConfirmModal: React.FC<Props> = ({
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    box: { backgroundColor: C.gray100, borderRadius: 16, padding: 24, width: '100%', maxWidth: 360, gap: 12 },
    ...
    cancelBtn: { flex: 1, paddingVertical: 11, borderRadius: 10, borderWidth: 1, borderColor: C.gray200, alignItems: 'center' },
    cancelTxt: { fontSize: 14, fontWeight: '600', color: C.gray700 },
    confirmBtn: { flex: 1, paddingVertical: 11, borderRadius: 10, backgroundColor: C.violet600, alignItems: 'center' },
    confirmTxt: { fontSize: 14, fontWeight: '600', color: '#fff' },
    destructiveBtn: { backgroundColor: C.red600 },
    destructiveTxt: { color: '#fff' },
    ...
    input: { borderWidth: 1, borderColor: C.gray200, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15, color: C.gray900, backgroundColor: C.gray50 },
  }), [C]);

  const handleCancel = () => { setInputText(''); onCancel(); };
  const handleConfirm = () => {
        ...
        <View style={s.box}>
          ...
          {!!requireConfirmationText && (
            <View style={s.inputContainer}>
              ...
              <TextInput style={s.input} value={inputText} onChangeText={setInputText} placeholder={requireConfirmationText} autoCapitalize="none" />
            </View>
          )}
          <View style={s.btns}>
            ...
            <TouchableOpacity style={[s.confirmBtn, destructive && s.destructiveBtn, isConfirmDisabled && s.disabledBtn]} onPress={handleConfirm} disabled={isConfirmDisabled}>
